...
// Adiciona uma nova publicacao no banco de dados
...
// Traz as publicacoes que apareceriam no feed do usuário
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível atualizar uma publicação que não sejá sua"))
		return
	}
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível remover uma publicação que não sejá sua"))
		return
	}
